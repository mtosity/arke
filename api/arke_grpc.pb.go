...
func (c *producerClient) Connect(ctx context.Context, in *ConnectionConfiguration, opts ...grpc.CallOption) (*ConnectResponse, error) {
	...
	err := c.cc.Invoke(ctx, Producer_Connect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *producerClient) Publish(ctx context.Context, opts ...grpc.CallOption) (Producer_PublishClient, error) {
	stream, err := c.cc.NewStream(ctx, &Producer_ServiceDesc.Streams[0], Producer_Publish_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *producerClient) Disconnect(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Producer_Disconnect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerClient) Connect(ctx context.Context, in *ConnectionConfiguration, opts ...grpc.CallOption) (*ConnectResponse, error) {
	out := new(ConnectResponse)
	err := c.cc.Invoke(ctx, Consumer_Connect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consumerClient) Consume(ctx context.Context, opts ...grpc.CallOption) (Consumer_ConsumeClient, error) {
	stream, err := c.cc.NewStream(ctx, &Consumer_ServiceDesc.Streams[0], Consumer_Consume_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *consumerClient) Disconnect(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, Consumer_Disconnect_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthzClient) Check(ctx context.Context, opts ...grpc.CallOption) (Healthz_CheckClient, error) {
	stream, err := c.cc.NewStream(ctx, &Healthz_ServiceDesc.Streams[0], Healthz_Check_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
